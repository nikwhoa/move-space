...
const Classes = () => {
  return (
    <>
      <motion.div transition={{duration: 0.75}} initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className="site-section section-2" id="classes-section">
        <div className="container">
          <div className="row">
            <div className="col-lg-8 mb-5">
              <h2 className="section-title">Тренування</h2>
              <p>
                Рух – це життя! А тренування – це рух у різних площинах і
                амплітудах, який не просто допомагає вам коригувати фігуру. Це
                рух – який дає вам шанс завжди почуватися молодими і здоровими:
              </p>
              <p>
              ...
              >
                <SwiperSlide>
                  <a className="work-thumb" href="single.html">
                    ...
                    <img src={slide4} alt="slide 4" className="img-fluid" />
                  </a>
                </SwiperSlide>
                <SwiperSlide>
                  <a className="work-thumb" href="single.html">
                ...
                <SwiperSlide>
                  <a className="work-thumb" href="single.html">
                    ...
                    <img src={slide2} alt="slide 3" className="img-fluid" />
                  </a>
                </SwiperSlide>
                <SwiperSlide>
                  <a className="work-thumb" href="single.html">
                    ...
                    <img src={slide1} alt="slide 3" className="img-fluid" />
                  </a>
                </SwiperSlide>
                <SwiperSlide>
                  <a className="work-thumb" href="single.html">
                    ...
                    <img src={slide0} alt="slide 3" className="img-fluid" />
                  </a>
                </SwiperSlide>
              </Swiper>
            </div>
